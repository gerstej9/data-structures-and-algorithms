...
const sortBackwards = (arr) => {
  const compareNumbers = (leftNum, rightNum) => {
    if( leftNum > rightNum){
      return -1;
...
const sortByLength = (arr) => {
  const compareString = (leftStr, rightStr) => {
...
const sortByPrice = (arr) => {
  const comparePrice = (lPrice, rPrice) => {
    if( lPrice.price > rPrice.price){
      return 1;
    }else if( lPrice.price < rPrice.price){
      return -1;
    }else{
      return 0;
    }
...
const sortPeople = (arr) => {
  const compareString = (leftStr, rightStr) => {
    if( leftStr.lastName.toLowerCase() > rightStr.lastName.toLowerCase()){
      return 1;
    }else if( leftStr.lastName.toLowerCase() < rightStr.lastName.toLowerCase()){
      return -1;
    }else{
      return 0;
    }
...
const sortPeopleBetter = (arr) => {
  const compareString = (leftStr, rightStr) => {
   ...
   if( leftStr.lastName > rightStr.lastName){
      return 1;
    }else if( leftStr.lastName < rightStr.lastName){
      return -1;
    }else if( leftStr.firstName> rightStr.firsName){
      return 1;
    }else if( leftStr.firstName< rightStr.firstName){
      return -1;
    }else if(leftStr.lastName === rightStr.lastName && leftStr.firstName === rightStr.firstName){
      if( leftStr.age> rightStr.age){
      return 1;
      }else if( leftStr.age < rightStr.age){
      return -1;
      };
    }else{
      return 0;
